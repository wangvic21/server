...
<template>
	<SettingsSection :title="t('federatedfilesharing', 'Federated Cloud')"
		...
		<p class="cloudIdText">
			...
			<Button @click.prevent="copyCloudId()"
				class="clipboard"
		...
		<template v-if="showHtml">
			<p style="margin: 10px 0">
				<a target="_blank" rel="noreferrer noopener" :href="reference" :style="backgroundStyle">
